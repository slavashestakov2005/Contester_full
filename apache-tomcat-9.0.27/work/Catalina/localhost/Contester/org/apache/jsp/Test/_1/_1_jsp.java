 ...
 * Generated at: 2021-04-20 13:23:38 UTC
...
public final class _1_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t<center><h2>A+B</h2></center>\n");
      out.write("\t\t\t\t<center>(Время: 1 сек. Память: 16 Мб)</center>\n");
      out.write("\t\t\t\t<h3>Условие:</h3>\n");
      out.write("\t\t\t\t<p>Вводятся числа A и B. Выведите их сумму :)</p>\n");
      out.write("\t\t\t\t<h3>Входные данные:</h3>\n");
      out.write("\t\t\t\t<p>Два целых числа, таких что \\( |A| \\leq 10^9 \\) и \\( |B| \\leq 10^9 \\).</p>\n");
      out.write("\t\t\t\t<h3>Выходные данные:</h3>\n");
      out.write("\t\t\t\t<p>Выведите одно число, сумму входных чисел.</p>\n");
      ...
      out.write("\t\t\t\t\t");
 out.print("<form action=\"../../run?contest=1&task=1&name="); 
 ...
 out.print("\" method=\"post\">"); 
      ...
      out.write("\t\t\t\t\t</form>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t\t<button onclick=\"document.location.href='1_solution.jsp'\">Решение</button>\n");
