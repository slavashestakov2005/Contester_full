 ...
 * Generated at: 2021-03-25 13:50:51 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.User._2;
...
public final class _5_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t<center><h2>A. Корыстный олимпиадник</h2></center>\n");
      out.write("\t\t\t\t<center>(Время: 1 сек. Память: 256 Мб)</center>\n");
      out.write("\t\t\t\t<h3>Условие:</h3>\n");
      out.write("\t\t\t\t<p>На одной небезызвестной олимпиаде \\(n\\) человек взяли дипломы победителей. Теперь единственное, что эти победители обсуждают — размер премии за успешное выступление на олимпиаде. Один из них устал ждать денег, поэтому он пошёл в министерство образования и потребовал свою премию.</p>\n");
      out.write("\t\t\t\t<p>В министерстве образования сжалились и решили выделить корыстному олимпиаднику его премию. Бюджет премий был разделён на \\(n\\) почти равных частей так, что в каждой части было целое число денег, и разница числа денег между любыми двумя частями не превышала \\(1\\). Корыстному олимпиаднику дали наименьшую из всех частей. После этого в бюджете премий осталось \\(m\\) денег, и они в дальнейшем были распределены между оставшимися \\(n - 1\\) победителями олимпиады.</p>\n");
      out.write("\t\t\t\t<p>Теперь победителям олимпиады интересно, а какой же был изначальный бюджет премий. Помогите им это выяснить.</p>\n");
      out.write("\t\t\t\t<h3>Входные данные:</h3>\n");
      out.write("\t\t\t\t<p>В первой строке вводится единственное число \\( n (2 \\leq n \\leq 15) \\) — число победителей олимпиады.</p>\n");
      out.write("\t\t\t\t<p>Во второй строке вводится единственное число \\( m (n \\leq m \\leq 100) \\) — число оставшихся денег в бюджете премий после выдачи премии корыстному олимпиаднику.</p>\n");
      out.write("\t\t\t\t<h3>Выходные данные:</h3>\n");
      out.write("\t\t\t\t<p>В единственной строке выведите два числа — минимальное и максимальное возможное число денег в изначальном бюджете премий.</p>\n");
      out.write("\t\t\t\t<h3>Примеры:</h3>\n");
      out.write("\t\t\t\t<table border=\"1\" width=\"95%\">\n");
      out.write("\t\t\t\t\t<tr>\n");
      out.write("\t\t\t\t\t\t<td width=\"50%\"><center>Input</center></td>\n");
      out.write("\t\t\t\t\t\t<td width=\"50%\"><center>Output</center></td>\n");
      out.write("\t\t\t\t\t</tr>\n");
      out.write("\t\t\t\t\t<tr>\n");
      out.write("\t\t\t\t\t\t<td>\n");
      out.write("\t\t\t\t\t\t\t<p>2</p>\n");
      ...
      out.write("\t\t\t\t\t");
 out.print("<form action=\"../run?contest=2&task=5&name="); 
 ...
 out.print("\" method=\"post\">"); 
      ...
      out.write("\t\t\t\t\t</form>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t\t<button onclick=\"viewCode(document, page_number)\">Мои посылки</button>\t\t\t\t<div id=\"down2\"></div>\n");
      out.write("\t\t\t</div>\n");
      out.write("\t\t</div>\n");
      out.write("\t</body>\n");
      out.write("</html>");
