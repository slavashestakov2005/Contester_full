 ...
 * Generated at: 2021-03-23 14:37:33 UTC
...
public final class _7_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t<center><h2>Задача №5</h2></center>\n");
      out.write("\t\t\t\t<center>(Время: 1 сек. Память: 16 Мб)</center>\n");
      out.write("\t\t\t\t<h3>Условие:</h3>\n");
      out.write("\t\t\t\t<p>Проверка способностей \\( \\LaTeX \\).</p>\n");
      out.write("\t\t\t\t<p>\\( V = \\frac{4}{3} \\pi R ^ 3 \\)</p>\n");
      out.write("\t\t\t\t<p>\\( S = 4 \\pi R ^ 2 \\)</p>\n");
      out.write("\t\t\t\t<div id=\"code\">\n");
      out.write("\t\t\t\t\t<p>Решение:</p>\n");
      out.write("\t\t\t\t\t");
 out.print("<form action=\"../run?contest=1&task=7&name="); 
