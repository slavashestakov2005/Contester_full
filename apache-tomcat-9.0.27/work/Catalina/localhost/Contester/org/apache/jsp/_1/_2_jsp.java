 ...
 * Generated at: 2021-03-03 13:52:30 UTC
...
public final class _2_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t<center><h2>Задача с LaTeX</h2></center>\n");
      out.write("\t\t\t\t<center>(Время: 0.001 сек. Память: 1 Мб)</center>\n");
      out.write("\t\t\t\t<h3>Условие:</h3>\n");
      out.write("\t\t\t\t<p>В задачах можно использовать \\( \\LaTeX{} \\).</p>\n");
      out.write("\t\t\t\t<p>Он находится между символами \\ ( и \\ ) (без пробела между ними).</p>\n");
      out.write("\t\t\t\t<p>Часто используемые символы:</p>\n");
      out.write("\t\t\t\t<p>\\(\\alpha\\) — \\alpha — и другие греческие буквы.</p>\n");
      out.write("\t\t\t\t<p>\\(\\frac{a}{b}\\) — \\frac{a}{b} — дроби.</p>\n");
      out.write("\t\t\t\t<p>\\( a^{b} и a_b \\) — a^{b} и a_b — стпени и индексы.</p>\n");
      out.write("\t\t\t\t<p>\\( \\leq и \\geq \\) — \\leq и \\geq — знаки сравнения.</p>\n");
      out.write("\t\t\t\t<p>\\( \\prime \\) — \\prime — одинарная кавычка.</p>\n");
      out.write("\t\t\t\t<p>\\( \\dotso \\) — \\dotso — многоточие для кокатенации строк.</p>\n");
      ...
      out.write("\t\t\t\t\t<tr>\n");
      out.write("\t\t\t\t\t\t<td>\n");
      out.write("\t\t\t\t\t\t\t<p>Входные данные примера 1.</p>\n");
      out.write("\t\t\t\t\t\t</td>\n");
      out.write("\t\t\t\t\t\t<td>\n");
      out.write("\t\t\t\t\t\t\t<p>Выходные данные.</p>\n");
      out.write("\t\t\t\t\t\t</td>\n");
      out.write("\t\t\t\t\t</tr>\n");
      out.write("\t\t\t\t</table>\n");
      ...
      out.write("\t\t\t\t\t");
 out.print("<form action=\"../run?contest=1&task=2&name="); 
