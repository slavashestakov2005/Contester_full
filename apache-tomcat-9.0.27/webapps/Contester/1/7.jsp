...
<html lang="ru">
	...
	<body>
		...
		<div id="page">
			...
			<div id="content">
				<center><h2>Новое</h2></center>
				<center>(Время: 1 сек. Память: 16 Мб)</center>
				<h3>Условие:</h3>
				<p>Проверка способностей \( \LaTeX \).</p>
				<p>\( V = \frac{4}{3} \pi R ^ 3 \)</p>
				<p>\( S = 4 \pi R ^ 2 \)</p>
				<div id="code">
					<p>Решение:</p>
					<% out.print("<form action=\"../run?contest=1&task=7&name="); %>${cookie['name'].getValue()}<% out.print("&surname="); %>${cookie['surname'].getValue()}<% out.print("\" method=\"post\">"); %>
