	...
	<body>
		...
		<div id="page">
			...
			<div id="content">
				...
				<p>В любой части описания задач можно свободно использовать " и '.</p>
				<p>Все "опасные" символы лучше выводить с помощью "document.write(ToCorrectText("<script>document.write(ToCorrectText("	~ ! @ # $ % * () _ — + = | : ; \" ' < > , . ? / ^"));</script>"));". Результат:</p>
				<p><script>document.write(ToCorrectText("	~ ! @ # $ % * () _ — + = | : ; \" ' < > , . ? / ^"));</script></p>
				<div id="code">
					<p>Решение:</p>
