...
<html lang="ru">
	...
	<body>
		...
		<div id="page">
			...
			<div id="content">
				<center><h2>Ещё новое задание</h2></center>
				<center>(Время: 1 сек. Память: 16 Мб)</center>
				<h3>Условие:</h3>
				<p>Для проверки TLE и MLE.</p>
				<div id="code">
					<p>Решение:</p>
					<% out.print("<form action=\"../run?contest=1&task=8&name="); %>${cookie['name'].getValue()}<% out.print("&surname="); %>${cookie['surname'].getValue()}<% out.print("\" method=\"post\">"); %>
